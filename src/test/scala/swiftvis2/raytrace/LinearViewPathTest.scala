...
class LinearViewPathTest extends FlatSpec with Matchers {
  ...
  it should "adjust the direction in apply" in {
    ...
    path(0.05) should be (View(Point(0, 0, 0), Vect(1, 0, 0), Vect(0, 1, 0)))
    path(0.6) should be (View(Point(0, 0, 0), Vect(0.5, 0.5, 0), Vect(0, 1, 0)))
  ...
  it should "adjust the up in apply" in {
    ...
    path(0.05) should be (View(Point(0, 0, 0), Vect(1, 0, 0), Vect(0, 1, 0)))
    path(0.6) should be (View(Point(0, 0, 0), Vect(1, 0, 0), Vect(0, 0.5, 0.5)))
  ...
  it should "adjust the location and direction in apply" in {
    ...
    path(1.625) should be (View(Point(1, 2, 4), Vect(0.5, 0.5, 0), Vect(0, 1, 0)))
    path(2.05) should be (View(Point(1, 2, 4), Vect(0, 1, 0), Vect(0, 1, 0)))
    path(2.625) should be (View(Point(1, 1.5, 2.5), Vect(0, 0.5, 0.5), Vect(0, 1, 0)))
  ...
  it should "adjust the location and direction with intervals" in {
    ...
    stops(11) should be (View(Point(1, 2, 4), Vect(5*1.0/6, 1.0/6, 0), Vect(0, 1, 0)))
    stops(12) should be (View(Point(1, 2, 4), Vect(4*1.0/6, 2*1.0/6, 0), Vect(0, 1, 0)))
    stops(13) should be (View(Point(1, 2, 4), Vect(3*1.0/6, 3*1.0/6, 0), Vect(0, 1, 0)))
    stops(14) should be (View(Point(1, 2, 4), Vect(2*1.0/6, 4*1.0/6, 0), Vect(0, 1, 0)))
    stops(15) should be (View(Point(1, 2, 4), Vect(1.0/6, 5*1.0/6, 0), Vect(0, 1, 0)))
    ...
    stops(19) should be (View(Point(1, 2 - 1.0/6, 4 - 3.0/6), Vect(0, 5*1.0/6, 1.0/6), Vect(0, 1, 0)))
    stops(20) should be (View(Point(1, 2 - 2*1.0/6, 4 - 2*3.0/6), Vect(0, 4*1.0/6, 2*1.0/6), Vect(0, 1, 0)))
    stops(21) should be (View(Point(1, 2 - 3*1.0/6, 4 - 3*3.0/6), Vect(0, 3*1.0/6, 3*1.0/6), Vect(0, 1, 0)))
    stops(22) should be (View(Point(1, 2 - 4*1.0/6, 4 - 4*3.0/6), Vect(0, 2*1.0/6, 4*1.0/6), Vect(0, 1, 0)))
    stops(23) should be (View(Point(1, 2 - 5*1.0/6, 4 - 5*3.0/6), Vect(0, 1.0/6, 5*1.0/6), Vect(0, 1, 0)))
