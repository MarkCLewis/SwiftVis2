...
object SparkPlotTesting {
  def main(args: Array[String]): Unit = {
    ...
    val pnts = ArraySeq.tabulate(100)(i => Point(i, i * i, 3 + 3 * math.random(), argb(1, math.random(), math.random(), math.random()), util.Random.nextInt(5),
